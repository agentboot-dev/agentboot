...
- **v0.20.x — assurance hardening, honest docs, and evaluation fixes (current).**
  Every verifier made fail-closed (telemetry signature enforcement, manifest
  trust posture, attestation binding, MCP digest correctness — pagination,
  ...
  `/docs/guardrails` page for a capability whose authoring syntax had been
  documented nowhere.
