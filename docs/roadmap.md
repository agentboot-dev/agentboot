...
## Where we are today — v0.12.2 (public Beta)

**AgentBoot v0.12.2 is a public Beta.** The full pipeline works end to end today: it compiles your
...
- **v0.12.2 — enterprise hardening (current).** The adopting‑organization batch: pluggable
